...
import com.github.melihemreguler.messagingwriterservice.config.KafkaRetryConfig;
import com.github.melihemreguler.messagingwriterservice.config.MessagingConfig;
...
public class MessageConsumerService {
    ...
    public void consumeMessageCommand(String message, 
        ...
        try {
            ...
            if (com.github.melihemreguler.messagingwriterservice.enums.MessageCommand.SEND_MESSAGE.getCommand().equals(event.getCommand())) {
